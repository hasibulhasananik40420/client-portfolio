    ...
    <div>
      ...
      <div className="max-w-container mx-auto lg:px-[230px] xl:px-[230px] 2xl:[230px]  px-4 md:px-8 mt-[12px]">
       ...
       <h3 className='text-[#242424] text-[20px] mt-[40px] font-Montserrat font-bold leading-[34px]'>Background</h3>
        ...
        <p className='mt-[20px] text-[#242424] md:text-[16px] text-[14px] font-Montserrat font-medium md:leading-6 leading-5 tracking-[-0.1px] italic lg:w-[700px] xl:w-[790px] 2xl:w-[920px] w-full'>Research & Insights, in collaboration Experience Design, was tasked with redesigning an existing employee application. In addition, the teams' director tasked both teams with creating a process that could be reused on future product redesigns across other employee applications.</p>

         <p className='mt-[10px] text-[#242424] md:text-[16px] text-[14px] font-Montserrat font-normal md:leading-6 leading-5 tracking-[-0.1px] lg:w-[790px] xl:w-[790px] 2xl:w-[910px] w-full'>My role was conducting observational research and prioritizing findings with Product. My findings were then reused by Experience Design to build additional documents (e.g. Journey Maps, Personas & Storyboards) to inform the first redesign</p>
         ...
         <div className='mt-[40px]'>
           ...
           <div className='flex gap-4 mt-[20px]'>
              <span className='w-[20px] h-[27px] flex justify-center items-center'>
               ...
               <p className='text-[#2B2B2B] md:text-[16px] text-[14px] font-normal font-Montserrat md:leading-6 leading-5 '>Drivers are missing features when completing daily tasks, which opens the door for human error and reliance on third-party tools</p>
             ...
             <span className='w-[20px] h-[27px] flex justify-center items-center'>
               ...
               <p className='text-[#2B2B2B] md:text-[16px] text-[14px]  font-normal font-Montserrat md:leading-6 leading-5 '>Drives are impacted by inaccurate or incomplete customer data entered by employees</p>
            ...
            <span className='w-[20px] h-[27px] flex justify-center items-center'>
               ...
               <p className='text-[#2B2B2B] md:text-[16px] text-[14px] font-normal font-Montserrat md:leading-6 leading-5'>Driver need customers to follow company policies to reduce wasted employee hours</p>
           ...
           <div className='flex gap-4 mt-5'>
              <span className='w-[20px] h-[27px] flex justify-center items-center'>
               ...
               <p className='text-[#2B2B2B] md:text-[16px] text-[14px] font-normal font-Montserrat md:leading-6 leading-5 '>Product aligned on what issues were addressable through user experience changes versus operational & multi-system changes</p>
        ...
        <div className='mt-[40px]'>
           ...
           <span className='w-[20px] h-[27px] flex justify-center items-center'>
               ...
               <p className='text-[#2B2B2B] md:text-[16px] text-[14px] font-normal font-Montserrat md:leading-6 leading-5 '>Keeping Product aligned throughout the entire research process was key to Product supporting and adopting the findings. This spanned from remaining connected on what type of participants were needed to what type of employee tasks were of most interest.</p>
             ...
             <span className='w-[20px] h-[27px] flex justify-center items-center'>
               ...
               <p className='text-[#2B2B2B] md:text-[16px] text-[14px] font-normal font-Montserrat md:leading-6 leading-5 '>Creating readout documents for executive and delivery teams allowed each audience to take appropriate next steps. The executive team readout, for example, helped inform what immediate roadmap changes were needed. The delivery team readout, however, served as a point of reference for design when creating wireframes and other-related documents.</p>
