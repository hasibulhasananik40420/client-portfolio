          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-6 2xl:ml-6 xl:ml-5 lg:ml-3 ml-0 lg:mt-0 md:mt-10 mt-10">
            ...
            >
              <div
                ...
                className="bg-[#F9FAFB] 2xl:h-[320px] xl:h-[320px] lg:h-[300px] md:h-[320px] h-[320px] p-6 flex flex-col gap-2 justify-center items-center group-hover:bg-[#88bff7] group-hover:rounded-t-[12px] duration-300"
              >
