  ...
  return (
    <div className=" mt-10 md:mt-10 lg:mt-0">
      <Slider {...sliderSettings}>
        <div
          className="outline-none border-none bg-[#F6EFFF] lg:w-[560px] w-full h-[416px] mb-2"
        ...
        <div
          className="outline-none border-none bg-[#F6EFFF] w-[560px] h-[416px]"
          style={{ borderRadius: "0px 0px 8px 8px" }}
        >
          <img className="w-[560px]" src={line} alt="" />
          <div className="pt-6">
            <img
              className="w-[512px] h-[340px] flex justify-center items-center mx-auto outline-none border-none"
              src={image2}
              alt=""
            />
          </div>
