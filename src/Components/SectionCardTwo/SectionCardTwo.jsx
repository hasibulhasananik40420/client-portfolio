...
import ExperienceMappingImage4 from '../../assets/Owned Research/1.Experience Mapping/010.png'
      ...
      <div  className={` bg-white pt-[150px] max-w-containerX mx-auto px-4 md:px-8 lg:px-4 `} id="OwnedResearch">
        ...
        <div className="lg:flex justify-between mt-[48px]">
          <div className="lg:w-[560px] w-full">
            ...
            This research focused on understanding how the target user base completed regularly daily tasks to determine whether the existing product roadmap addressed previously known and documented pain points. The research’s findings helped reinforce the urgency of one feature in the product roadmap, pulling it up into the next sizeable feature being released into the product.
        ...
        >
          <div className="lg:w-[560px] w-full">
            ...
            <p className="text-[#2B2B2B] text-[16px] font-Montserrat font-normal leading-6 mt-4">
            This research provided our teammates will a greater shared understanding on how the target user base completed regularly daily tasks, while also provided a forum for them to ask questions.
            </p>
        ...
        >
          <div className="lg:w-[560px] w-full">
            ...
            <p className="text-[#2B2B2B] text-[16px] font-Montserrat font-normal leading-6 mt-4">
            This research tested the new product with participants in our target user base. This findings helped inform what additional features should be added, along with providing insights to the trainings teams on unclear concepts and opportunities to support the launch of the new product
 ...
 {/* item 4 */}
        ...
        >
          <div className="lg:w-[560px] w-full">
            ...
            <p className="text-[#2B2B2B] text-[16px] font-Montserrat font-normal leading-6 mt-4">
            This research research helped test a live version of new the product. Since the new product was rolling out in markets in small pilot groups, this testing helped provide Product Management begin to understand how our non-pilot users, who would have less support than our pilot users, may experience the new product  
 ...
 {/* item 5 */}
        ...
        >
          <div className="lg:w-[560px] w-full">
            ...
            <p className="text-[#2B2B2B] text-[16px] font-Montserrat font-normal leading-6 mt-4">
            This research helped provided training will feedback, after going through training, on how confident our target user group felt using the new changes and the overall learning objectives. Since the   
 ...
 {/* item 6 */}
        ...
        >
          <div className="lg:w-[560px] w-full">
            ...
            <p className="text-[#2B2B2B] text-[16px] font-Montserrat font-normal leading-6 mt-4">
            This research helped benchmark satisfaction with new the product, before moving into additional pilot groups, with also providing sentiment analysis on why participants reported such satisfaction sources 
          ...
          <div className="lg:w-[560px] w-full  h-[388px] ">
          <CustomSlider images={BenchmarkingData} />
          </div>
        </div>
 ...
 {/* item 2 */}
        <div className="lg:flex justify-between mt-[120px]">
          <div className="lg:w-[620px] w-full">
            ...
            <p className="text-[#2B2B2B] text-[16px] font-Montserrat font-normal leading-6 mt-4">
            This research helped to articulate how planned upgrades to the new product would fit into the target user base’s regular daily tasks. My role was to review the material and spotlight where the planned upgrades did not contain solutions addressing pain points collected during Experience Mapping research. 
...
{/* item 3 */}
        <div className="lg:flex justify-between mt-[120px]">
          <div className="lg:w-[620px] w-full">
            ...
            <p className="text-[#2B2B2B] text-[16px] font-Montserrat font-normal leading-6 mt-4">
            This research helped benchmark the target user base’s satisfaction with their existing product, to compare against the new product being introduced. The sentiment responses also spotlighted pain points to monitor for when the new product was released. My role was a reviewer, specifically in the tagging of the sentiment analysis 
      ...
      <div className="bg-white pt-[170px] max-w-containerX mx-auto px-4 md:px-8 lg:px-4" id="ProposedResearch">
       ...
       {/* item 1 */}
        <div
          className="lg:flex justify-between mt-[48px]"
          id="ConceptTesting"
        >
          <div className="lg:w-[620px] w-full">
            <span className="flex items-center gap-2">
            ...
            <p className="text-[#2B2B2B] text-[16px] font-Montserrat font-normal leading-6 mt-4">
            This research would measure how often key features were being used in the new product over a period of time. This insights would provide help provide additional context into user satisfaction scores (i.e., after 2 weeks of usage) for the new product 
            </p>
     ...
     {/* item 2  */}
        <div
          className="lg:flex justify-between mt-[110px]"
          id="Post-release"
        >
          <div className="lg:w-[620px] w-full">
            <span className="flex items-center gap-2">
            ...
            <p className="text-[#2B2B2B] text-[16px] font-Montserrat font-normal leading-6 mt-4">
            This research would begin collecting feedback on the future state version of the new product. This product contained features not slated for development, but were vetted for technical feasibility and are reaching a prototype state. These features represent business aspirations that would need to be aligned with target user feedback to be molded into a realistic/viable solution. 
        ...
        >
          <div className="lg:w-[620px] w-full">
            ...
            <p className="text-[#2B2B2B] text-[16px] font-Montserrat font-normal leading-6 mt-4">
            This research would begin collecting feedback on future state version of the new product’s features, and identifying which are most likely to satisfy the target user base. This research would help our Product teams weigh a high-satisfaction feature against its costs to implement to determine whether or not adding it to the roadmap is a strategically sound decision
