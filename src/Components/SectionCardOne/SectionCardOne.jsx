...
const SectionCardOne = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const button1Threshold = 0;
      const button2Threshold = 3400; // Adjust this value based on your specific requirements
      const button3Threshold = 5800; // Adjust this value based on your specific requirements
