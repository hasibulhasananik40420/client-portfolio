    ...
    const faqData = [
        ...
        
        {
          ...
          images: [
            ...
            { id: 2, image: SemiStructuredInterviewsImage2, text: "Semi-structured Interviews - Past Research Informing Interview Questions" },
            { id: 3, image: SemiStructuredInterviewsImage3, text: "Semi-structured Interviews - Interview Guide " },
            { id: 4, image: SemiStructuredInterviewsImage4, text: " Semi-structured Interviews - Executive Report Readout (1 of 3) " },
            { id: 5, image: SemiStructuredInterviewsImage5, text: "Semi-structured Interviews - Executive Report Readout (2 of 3) " },
            { id: 6, image: SemiStructuredInterviewsImage6, text: "Semi-structured Interviews - Executive Report Readout (3 of 3) " },
        ...
        },
        {
          ...
          images: [
            ...
            { id: 2, image: ExperienceMappingImage2, text: "Journey Mapping - Visualizing current ways of working to pinpoint feature integration opportunities (1 of 2)" },
            { id: 3, image: ExperienceMappingImage3, text: "Journey Mapping - Visualizing current ways of working to pinpoint feature integration opportunities (2 of 2)" },
